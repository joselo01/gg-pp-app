    ...
    return (
      <div className="col-12 col-sm-3 col-xl-2 px-sm-2 bg-dark d-flex sticky-top nav-style">
        <div className="d-flex flex-sm-column flex-row flex-grow-1 align-items-center align-items-sm-start px-3 pt-2 text-white">
          ...
          >
            <span className="fs-5">
              G<span className="d-none d-sm-inline">loria,</span> Hola {nombre}
            </span>
          </Link>
          <ul
          ...
          >
            ...
            <li className="dropdown">
              ...
              >
                <i className="fs-5 bi-card-list"></i>
                <span className="ms-1 d-none d-sm-inline">Administración</span>
              </Link>
              <ul
                className="dropdown-menu dropdown-menu-light text-small shadow text-white"
                aria-labelledby="dropdown"
              >
                ...
                <li>
                  <Link className="dropdown-item" to="./secondary-accounts">
                    Administrar usuarios
                  </Link>
                </li>
                <li>
                  <Link className="dropdown-item" to="./reasign-accounts">
                ...
                <li>
                  <Link className="dropdown-item" to="./change-requests">
                    Mis Solicitudes
                  </Link>
                </li>
              </ul>
